package fr.jarven.camhead.lib.skullcreator;
...
public class SkullCreator {
	 ...
	 */
	public static void blockWithUuid(Block block, UUID id, boolean replaceBlock) {
		notNull(block, "block");
		notNull(id, "id");
	 ...
	 */
	public static void blockWithUrl(Block block, String url, boolean replaceBlock) {
		notNull(block, "block");
		notNull(url, "url");

		blockWithBase64(block, urlToBase64(url), replaceBlock);
	}
	 ...
	 */
	public static void blockWithBase64(Block block, String base64, boolean replaceBlock) {
		notNull(block, "block");
		notNull(base64, "base64");
